...
def main():
    ...
    audio_paths = glob.glob("./ICSI/audio/*/chanF.wav") 
    total_meeting_num = len(audio_paths)
    train_meeting_num = (total_meeting_num // 10) * 9
    ...
    # Iterate over the audio of all meetings
    for i, audio_path in enumerate(tqdm.tqdm(audio_paths, desc="Meeting", position=0)):

        # Get transcript for mrt file
