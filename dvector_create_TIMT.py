...
#dataset path
audio_path = glob.glob("./ICSI/audio/*/chanF.wav") 
annot_path = glob.glob("./ICSI/transcripts/*.mrt") 
total_meeting_num = len(audio_path)
train_meeting_num = (total_speaker_num//10)*9            # split total data 90% train and 10% test
nfiles = len(glob.glob("./ICSI/segments/*/*.wav"))
